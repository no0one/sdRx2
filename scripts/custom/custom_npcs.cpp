...
#define HOW_TO_BECOME_VIP    "How can I become a VIP?"
#define QUESTLIST            "I would like to begin my quest VIP."
#define VENDORLIST           "Show me your goods."
#define NEWS                 "Tell me the news."
#define STARTED_VIP_QUEST    "Thank you donated."
#define TRAINLIST            "I would like to continue my education"
...
{
    ObjectGuid pguid = pPlayer->GetObjectGuid();
...
bool QuestAccept_vip_master(Player *pPlayer, Creature *pCreaturereature, Quest const *quest)
{
